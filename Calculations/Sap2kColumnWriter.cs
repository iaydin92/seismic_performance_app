...
namespace AESPerformansApp.Calculations
{
    ...
    /// </summary>
    public class Sap2kColumnWriter 
    {
        private readonly string _sapFilePath;
        private readonly string _s2kFilePath;

        public Sap2kColumnWriter (string sapFilePath)
        {
        ...
        /// </summary>
        public void WriteColumnHingeDefinitions (string hingeName, ColumnHingeData hingeData)
        {
            try
            {
        ...
        /// </summary>
        private void AddHingeDefinitions(List<string> lines, string hingeName, ColumnHingeData hingeData)
        {
        ...
        /// </summary>
        private void AddHingeDef02Table(List<string> lines, string hingeName, ColumnHingeData hingeData)
        {
        ...
        /// </summary>
        private void AddHingeDef03Table(List<string> lines, string hingeName, ColumnHingeData hingeData)
        {
        ...
        /// </summary>
        private void AddHingeDef04Table(List<string> lines, string hingeName, ColumnHingeData hingeData)
        {
